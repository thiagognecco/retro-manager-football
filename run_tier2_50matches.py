#!/usr/bin/env python3
"""
TIER 2 Integration Test - 50 Matches
Runs in background, saves output to file
"""
...
output_file = r"C:\Users\gnecc\Documents\Footbal manager\TIER2_TEST_RESULTS.txt"

with open(output_file, 'w') as f:
    f.write("=" * 140 + "\n")
    f.write("TIER 2 INTEGRATION TEST - 50 Matches\n")
    f.write("=" * 140 + "\n\n")
    ...
    f.write(f"Running {num_matches} matches with TIER 1 + TIER 2 systems...\n\n")
    f.flush()
